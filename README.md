...
Co-first author on a PLOS Computational Biology paper modeling how response-range constraints shape heading estimates from optic flow. First author on a Journal of Vision paper on attractive serial dependence in heading perception.
